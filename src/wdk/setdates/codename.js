...
var text = document.createTextNode("Stone");                                    
document.getElementById("codename").appendChild(text); 
var text2 = document.createTextNode("Electron 12.0.6");                                    
document.getElementById("electron-version").appendChild(text2); 
var text3 = document.createTextNode(" WDK: 15.3 LTS");                                    
document.getElementById("wdk-version").appendChild(text3); 
var text5 = document.createTextNode(" Version: 17 (Stable) Compilacion 2021.05.16.1");                                    
