    ...
    tasksView.innerHTML += `<div class="card mb-3">
        <div class="card-body" style="background:black;border:black;">
         ...
         <p style="text-align:center;"> ${description}</p>
          ...
          <a href="${description}" onclick="window.open(this.href, this.target, 'width=1280,height=720'); return false;"  class="btn btn-dark ml-5">Abrir Link De ${title} Notely En Ventana  </a>
          </p>
        </div>
      </div>`;
  }
